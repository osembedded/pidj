...
var discovery = function(){
	...
	function setupSocket(){
		...
		sock.on("message", function(msg, rinfo){
			...
			var srv = _parseDiscoveryResp(msg.toString());
	...
	function _addDevice(keyValObj){
		if(!(keyValObj.key in myServers)){
			myServers[keyValObj.key] = keyValObj.value;
			console.log("Added - " + keyValObj.key + ": " + keyValObj.value);
		}
	}
